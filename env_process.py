...
from ipc_utils import cleanup_socket, send_ipc_handle
...
class EnvProcess:
    ...
    def allocate_shared_buffer(self):
        ...
        print("  注: GPU 物理地址由 NVIDIA 驱动管理，用户空间只能访问设备虚拟地址")
        print("  两个进程通过 CUDA IPC 句柄映射到相同的 GPU 物理显存区域")
